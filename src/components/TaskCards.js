                  ...
                  <div className="bg-zinc-950/60 rounded-xl p-3 border border-zinc-900 mb-4 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center font-mono">
                      <div className="bg-zinc-900/60 p-2 rounded-lg border border-zinc-800">
                        ...
                        <div className="text-orange-400 font-bold text-xs mt-0.5">{task.bill?.allocatedHours || 0}h</div>
                      </div>
                      <div className="bg-zinc-900/60 p-2 rounded-lg border border-zinc-800">
                        <div className="text-[10px] text-zinc-500">Billed</div>
                        <div className="text-amber-400 font-bold text-xs mt-0.5">{task.bill?.billedHours || 0}h</div>
                      </div>
                      <div className="bg-zinc-900/60 p-2 rounded-lg border border-zinc-800">
                        <div className="text-[10px] text-zinc-500">Actual</div>
                        <div className="text-yellow-500 font-bold text-xs mt-0.5">{task.bill?.actualHours || 0}h</div>
                      </div>
                    </div>
                  </div>
