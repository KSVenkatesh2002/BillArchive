        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="p-3.5 bg-black rounded-xl border border-zinc-800/80">
            ...
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-white placeholder-zinc-655 focus:outline-none focus:border-orange-500"
            />
